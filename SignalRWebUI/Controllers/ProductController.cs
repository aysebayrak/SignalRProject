...
namespace SignalRWebUI.Controllers
{
    public class ProductController : Controller
    {
        ...
        string baseUrl = "https://localhost:7085/api/Product";
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync(baseUrl+ "/ProductListWithCategory");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:7085/api/Category");
            var jsonData = await responseMessage.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> UpdateProduct(int id)
        {
            ...
            var responseMessage1 = await client1.GetAsync("https://localhost:7085/api/Category");
