...
namespace SignalRWebUI.Controllers
{
	public class NotificationsController : Controller
	{
		...
		string baseUrl = "https://localhost:7085/api/Notification";
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7085/api/Notification/NotificationStatusChangeToTrue/{id}");
            return RedirectToAction("Index");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7085/api/Notification/NotificationStatusChangeToFalse/{id}");
            return RedirectToAction("Index");
        }
